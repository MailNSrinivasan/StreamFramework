...
public class MD5 {
	...
	public void setInBytes(byte[] aInBytes) {
		in = aInBytes;
	}
	
	public void setInInt(int[] aInt) {
		inint = aInt;
	}
	...
	public void initialize(int aBuf[], byte aIn[], long aBits) {
		buf = aBuf;
		in = aIn;
		bits = aBits;
	}
